...
export default function Akinator()
{
  ...
  return (
    ...
    {/* <div className= "vs">
        <img src="/src/FrontGame/img/vs.png"/>
     
    </div> */}
  
    {/* <div id="profile1"> 
          <img className='profile1Img' src='/src/FrontGame/img/akinator.png'></img>
    ...
    <div id="profile2">
          <img className='profile2Img' src='/src/FrontGame/img/jenny.png'></img>
    ...
    <canvas ref={canvas} id = "canvas1"  height = "600" width = "1000" > </canvas>
      <div id="start">
        ...
        <img className='Iconpaddles' src="/src/FrontGame/img/IconPaddles.png"></img>
        </button>
      </div>
